...
// Navbar scroll threshold — show after scrolling past ~80% of the scroll-spacer (300vh)
const NAV_SHOW_SCROLL_THRESHOLD = window.innerHeight * 2.5;

// Show / hide the navbar based on scroll position
function updateNavVisibility() {
  if (window.scrollY > NAV_SHOW_SCROLL_THRESHOLD) {
...
async function init() {
  ...
  // GET STARTED button — redirect to the app selection page
  if (getStartedBtn) {
